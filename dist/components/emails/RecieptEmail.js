...
var RecieptEmail = function (_a) {
    var email = _a.email, date = _a.date, orderId = _a.orderId, productsList = _a.productsList;
    var total = productsList.reduce(function (accum, product) { return accum + product.price; }, 0);
